...
class DataType
{
     ...
     *
     * @param ValidatorField $validator
     *            A validator field.
     */
    ...
    /**
     * Convert a value such that it is compatible with this data type.
     * The
     ...
     *            Value.
     * @param bool $strict
     *            If true, the function will only use strict conversion
     ...
     *
     * @param int $flags
     *            Combination of: UNSIGNED, SERIAL, BIG, SMALL, TINY.
     * @param bool $null
     *            Whether or not type is nullable.
     ...
     *
     * @param int $length
     *            String maximum length (0 to 255).
     * @param bool $null
     *            Whether or not type is nullable.
     ...
     *            Enum values as strings. Keys must be integers.
