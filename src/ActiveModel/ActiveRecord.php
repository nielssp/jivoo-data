...
class ActiveRecord implements Record
{
     ...
     *            Names of allowed fields.
     */
    final private function __construct(ActiveModel $model, $data = array(), $allowedFields = null)
    {
        $this->model = $model;
    ...
    public function __get($field)
    {
        ...
        if (isset($this->associations[$field])) {
            if (! array_key_exists($field, $this->associationObjects)) {
                $this->associationObjects[$field] = $this->model->getAssociation($this, $this->associations[$field]);
            }
    ...
    public function __set($field, $value)
    {
        ...
        } elseif (isset($this->associations[$field])) {
    ...
    /**
     * Whether or not a field has been changed, i.e.
     ...
     *
     * @param bool $validate
     *            Whether or not to validate record before saving.
