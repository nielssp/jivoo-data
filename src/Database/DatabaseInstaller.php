...
class DatabaseInstaller extends InstallerSnippet
{
    ...
    protected $helpers = array(
        ...
        'Form',
        'Notify',
        'Jivoo\Data\Database\DatabaseDrivers'
    );
        ...
        if (isset($data)) {
            ...
            if ($form->isValid()) {
                ...
                try {
                    ...
                    $options = array_flip(array_merge($driver['requiredOptions'], $driver['optionalOptions']));
                    ...
                    $this->Notify->error = tr('An error occured: %1', $exception->getMessage());
                }
            }
        } else {
